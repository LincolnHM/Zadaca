-- ==========================================================
-- UBIGEO COMPLETO DEL PERU (24 departamentos + Callao, 196
-- provincias, 1874 distritos) -- reemplaza los 12 distritos de
-- muestra que traia el seed.sql original.
--
-- Fuente: dataset publico ernestorivero/Ubigeo-Peru (INEI 2016),
-- https://github.com/ernestorivero/Ubigeo-Peru -- mismo codigo de 6
-- digitos (departamento+provincia+distrito) que ya usa la columna
-- codigo_ubigeo de la tabla, asi que las direcciones que los clientes
-- ya hayan guardado siguen apuntando al mismo distrito (ON CONFLICT
-- actualiza el nombre en vez de duplicar la fila).
--
-- OJO: 3 de los 12 codigos que ya tenia la tabla estaban mal armados
-- (no correspondian al distrito real de ese codigo INEI) --
-- 150140 decia 'San Isidro' y en realidad es Santiago de Surco;
-- 150135 decia 'San Borja' y en realidad es San Martin de Porres
-- (justo donde esta tu tienda fisica); 150132 decia 'San Miguel' y
-- en realidad es San Juan de Lurigancho. Este script los corrige.
-- Si alguna direccion de cliente ya usaba esos 3 codigos pensando que
-- eran otro distrito, el texto que ve ahora sera el correcto.
--
-- Ejecutar en el SQL Editor de Supabase (puede tardar unos segundos por el volumen de filas).
-- ==========================================================
...
('030611', 'Apurímac', 'Chincheros', 'Los Chankas'),
...
('051010', 'Ayacucho', 'Víctor Fajardo', 'Hualla'),
...
('080914', 'Cusco', 'La Convención', 'Megantoni'),
...
('100609', 'Huánuco', 'Leoncio Prado', 'Pueblo Nuevo'),
('100610', 'Huánuco', 'Leoncio Prado', 'Santo Domingo de Anda'),
